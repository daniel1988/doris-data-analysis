    ...
    <el-card shadow="never" class="result-card">
      <template #header>
        <div class="result-header">
          ...
          <div class="header-right" v-if="!hideChart">
            <el-radio-group :model-value="vizMode" size="small" @update:model-value="$emit('update:vizMode', $event)">
              ...
              <el-radio-button value="bar">对比图</el-radio-button>
              <el-radio-button value="pie">分布图</el-radio-button>
            </el-radio-group>
            <div class="ops ml-10">
      ...
      <!-- 图表区域 -->
      <div v-if="!hideChart" v-loading="loading" class="chart-section">
        <ChartView ref="chartViewRef" :rows="rows" :columns="columns" :viz-mode="vizMode" />
      </div>

      <!-- 表格区域 -->
      <div v-loading="loading" :class="['table-section', hideChart ? '' : 'mt-20']">
